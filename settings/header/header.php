...
class header{
    ...
    public function displayHeader(){
        ...
        <head>
           ...
           <title>Edtech Classroom | Settings</title>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                      ...
                      <a class="nav-link text-light" href="../notifications">
                        Notify <i class="fa fa-bell"></i></b></i><span class="badge bg-light text-dark">'.$this->notification_total.'</span>
                      </a>
                ...
                <div class="collapse navbar-collapse" id="dropdown">
                  ...
                  <ul class="navbar-nav me-auto mb-2">
                      ...
                      <a class="nav-link text-light">
                       <b><i class="fa fa-cogs"></i> Settings</b>
                      </a>
