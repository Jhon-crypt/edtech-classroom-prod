...
** File name : resources/database/students-assignment-db-connection.php
...
$username = "john";
$password = "root";
$database = "edtech_classroom_student_assignment";

$conn4 = new mysqli($hostname,$username,$password,$database);
