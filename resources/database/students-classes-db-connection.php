...
** File name : resources/database/students-classes-db-connection.php
...
$username = "john";
$password = "root";
$database = "edtech_classroom_student_classes";

$conn3 = new mysqli($hostname,$username,$password,$database);
