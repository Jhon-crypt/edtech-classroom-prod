...
class header{
    ...
    public function displayHeader(){
        ...
        <head>
           ...
           <!--Bootsrap css link-->
           <link href="../resources/libraries/bootstrap-library/css/bootstrap.min.css" rel="stylesheet">

           <!--font awesome icons link-->
           <link rel="stylesheet" href="../resources/libraries/font-awesome-library/css/font-awesome.min.css">
        ...
        <script src="../resources/libraries/bootstrap-library/js/bootstrap.bundle.min.js"></script>
        ...
        style="background-color:#1d007e;"">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active text-dark" aria-current="page" href="lecturers-analytics.php">
                    <b><i class="fa fa-mortar-board"></i> Lecturers</b>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link text-dark" href="courses-analytics.php">
