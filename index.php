  ...
  public function homePage(){
    ...
    <head>
        ...
        <!--Bootsrap css link-->
         ...
         <link rel="stylesheet" 
         href="resources/libraries/font-awesome-library/css/font-awesome.min.css">
          ...
          <div class="col">
            ...
            <div class="card shadow p-4 mb-4 bg-light" style="max-height:400px;">
              ...
              <div class="card-body">
                 ...
                 <p class="card-text">
                   Digitalization of instructional materials helps the Edtech Classroom to be hub of E-books 
      ...
      <div class="container">
        ...
        <ul class="nav flex-column">
              ...
              <li class="nav-item">
                ...
                <a class="nav-link text-dark" href="login">
                  Like on facebook <i class="fa fa-facebook-square"></i>
                </a>
        ...
        <p class="text-secondary" style="font-family:monospace;" align="center">
           <small>
            Department Of Educational Technology © 2022
          </smal>
        </p>
