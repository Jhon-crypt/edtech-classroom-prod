...
** File name : saved messages/lecturer-saved-messages.php

** About : this module fetches and displays the lecturer saved messages from a course class chat
 ...
 * display the header
 * define the lecturer saved messages query
 * cache the query
...
class lecturerSavedMessages{
    ...
    //define the lecturer saved messages query
    public function lecturerSavedMessagesQuery(){
       ...
       $query = "SELECT * FROM chat_save_of_user".$this->lecturer_session."  ORDER BY id DESC";
    ...
    public function cacheQuery(){
        ...
        $key = "lecturer_saved_messages_result";
    ...
    //define the lecturer saved messages data and display the lecturer saved messages
    public function displayLecturerSavedMessages(){
...
$lecturer_saved_messages_controller = new lecturerSavedMessages();

if(isset($_SESSION['lecturer_session'])){

    $lecturer_saved_messages_controller->fetchUserSession();

    $lecturer_saved_messages_controller->heading();

    $lecturer_saved_messages_controller->lecturerSavedMessagesQuery();

    $lecturer_saved_messages_controller->cacheQuery();

    $lecturer_saved_messages_controller->displayLecturerSavedMessages();
